...
class BatchBasedTransform(BasicTransform):
    ...
    def apply_to_image_batch(self, bboxes_batch: Sequence[BoxType], **params) -> List[BoxType]:
        raise NotImplementedError("Method apply_to_image_batchs is not implemented in class " + self.__class__.__name__)

    def apply_to_bboxes_batch(self, bboxes_batch: Sequence[BoxType], **params) -> List[BoxType]:
        raise NotImplementedError("Method apply_to_bboxes_batch is not implemented in class " + self.__class__.__name__)

    def apply_to_mask_batch(self, mask_batch: Sequence[BoxType], **params) -> List[BoxType]:
        raise NotImplementedError("Method apply_to_mask_batch is not implemented in class " + self.__class__.__name__)

    def apply_to_keypoints_batch(self, keypoints_batch: Sequence[BoxType], **params) -> List[BoxType]:
        raise NotImplementedError(
            "Method apply_to_keypoints_batch is not implemented in class " + self.__class__.__name__
        )
