...
class RandomRotate90(DualTransform):
    ...
    def apply_to_bboxes(self, bboxes: BBoxesInternalType, factor: int = 0, **params: Any) -> BBoxesInternalType:
        return F.bboxes_rot90(bboxes, factor=factor, **params)

    def apply_to_keypoints(
        self, keypoints: KeypointsInternalType, factor: int = 0, **params: Any
    ) -> KeypointsInternalType:
        return F.keypoints_rot90(keypoints, factor, **params)
