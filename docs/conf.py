...
copyright = (
    "{}, Buslaev Alexander, Alex Parinov, Vladimir Iglovikov, " "Evegene Khvedchenya",
    "Druzhinin Mikhail",
).format(datetime.datetime.now().year)
author = "Buslaev Alexander, Alex Parinov, Vladimir Iglovikov, Evegene Khvedchenya, " "Druzhinin Mikhail"
