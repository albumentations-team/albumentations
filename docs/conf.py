...
copyright = (
    "{}, Alexander Buslaev, Alex Parinov, Vladimir Iglovikov, " "Evegene Khvedchenya",
    "Mikhail Druzhinin".format(datetime.datetime.now().year),
)
author = (
    "Alexander Buslaev, Alex Parinov, Vladimir Iglovikov, Evegene Khvedchenya, "
    "Mikhail Druzhinin"
...
latex_documents = [
    (
        ...
        "Alexander Buslaev , Alexander Parinov, Vladimir Iglovikov",
        "Evegene Khvedchenya",
        "Mikhail Druzhinin",
        "manual",
    )
