...
@pytest.mark.parametrize(
    ...
    [
        ...
        ((20, 30, 40, 50), "xywh", (0.2, 0.3, 0.6, 0.8)),
        ((20, 30, 40, 50, 99), "xywh", (0.2, 0.3, 0.6, 0.8, 99)),
        ((20, 30, 60, 80), "xyxy", (0.2, 0.3, 0.6, 0.8)),
        ((20, 30, 60, 80, 99), "xyxy", (0.2, 0.3, 0.6, 0.8, 99)),
        ((0.2, 0.3, 0.4, 0.5), "xywh_center_norm", (0.01, 0.06, 0.41, 0.56)),
        ((0.2, 0.3, 0.4, 0.5, 99), "xywh_center_norm", (0.01, 0.06, 0.41, 0.56, 99)),
        ((0.2, 0.3, 0.5, 0.5), "xywh_norm", (0.2, 0.3, 0.7, 0.8)),
        ((0.2, 0.3, 0.5, 0.5, 99), "xywh_norm", (0.2, 0.3, 0.7, 0.8, 99)),
        ((49, 39, 40, 20), "xywh_center", (0.3, 0.3, 0.7, 0.5)),
        ((49, 39, 40, 20, 99), "xywh_center", (0.3, 0.3, 0.7, 0.5, 99)),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ((0.2, 0.3, 0.6, 0.8), "xywh", (20, 30, 40, 50)),
        ((0.2, 0.3, 0.6, 0.8, 99), "xywh", (20, 30, 40, 50, 99)),
        ((0.2, 0.3, 0.6, 0.8), "xyxy", (20, 30, 60, 80)),
        ((0.2, 0.3, 0.6, 0.8, 99), "xyxy", (20, 30, 60, 80, 99)),
        ((0.01, 0.06, 0.41, 0.56), "xywh_center_norm", (0.2, 0.3, 0.4, 0.5)),
        ((0.01, 0.06, 0.41, 0.56, 99), "xywh_center_norm", (0.2, 0.3, 0.4, 0.5, 99)),
        ((0.3, 0.3, 0.6, 0.8), "xywh_norm", (0.3, 0.3, 0.3, 0.5)),
        ((0.3, 0.3, 0.6, 0.8, 99), "xywh_norm", (0.3, 0.3, 0.3, 0.5, 99)),
        ((0.3, 0.3, 0.7, 0.5), "xywh_center", (49, 39, 40, 20)),
        ((0.3, 0.3, 0.7, 0.5, 99), "xywh_center", (49, 39, 40, 20, 99)),
    ],
)
